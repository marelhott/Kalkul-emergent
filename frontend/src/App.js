      ...
      <div className="mx-auto" style={{maxWidth: '1000px'}}>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass-panel">
              <h3 className="section-title" style={{fontFamily: 'Touche Medium, sans-serif'}}>
                <svg className="svg-icon type-date" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="text-center">
                ...
                <div className="space-y-4 text-left">
                  <h3 className="section-title text-center" style={{fontFamily: 'Touche Medium, sans-serif', fontSize: '18px'}}>
                    <svg className="svg-icon type-contact" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
